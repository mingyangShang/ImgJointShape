#!/usr/bin/env bash
THEANO_FLAGS=floatX=float32,device=cpu python src/linear_ae_ff_stable.py --num-epoches 10000 --update-times-g2d 10 --batch-size 256 --alt-loss --joint-dim 128 --train --recon-weight 0 > $reconWeight.log
